...
ModuleInfo = DefineModule(name= "MySQLPDO", author= "Hasan Osman", version="1.0")

@ModuleInfo.plugin("info.hasanosman.wb.mysqlpdo", caption= "MySQL PDO (Connect to Server)", input= [wbinputs.currentSQLEditor()], pluginMenu= "SQL/Utilities")
